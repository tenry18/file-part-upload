...
return [
    ...
    'processes'                => [
        [
            'class'    => \App\Processes\VideoToM3u8::class,
            'redirect' => false, // 重定向 stdin/stdout, true or false
            'pipe'     => 0, // 管道类型 0: no pipeline 1: SOCK_STREAM 2: SOCK_DGRAM
            'enable'   => true, //是否启用
        ],
//        [
...
//        ],
    ...
    'timer'                    => [
        ...
        'jobs'          => [
            ...
            [\App\Jobs\Timer\ClearPartTimer::class,[1000*60*60*6,true]],//n小时执行一次
        ],
        'max_wait_time' => 5,
    ],
    'events'                   => [],
...
//        'reactor_num'        => function_exists('swoole_cpu_num') ? swoole_cpu_num() * 2 : 4,
        ...
        'task_ipc_mode'      => 2,
//        'message_queue_key'=>'',//设置消息队列的KEY，仅在task_ipc_mode = 2/3时使用
        ...
        'http_compression'   => false,//启用压缩 laravels默认为false
